...
<body>
	...
	<div class="main">
		...
		<div class="addnewName">
			...
			<form id="myform" class="form formA" method="post" action="${ctx}/attr/add" >
				<fieldset>
					<div class="legend"><h3>添加属性名</h3><a href="${ctx}/attr/list">返回属性名列表</a></div>
					<dl class="item">
						<dt class="item-label"><label><em>*</em>属性名：</label></dt>
						<dd class="item-cont">
							<input type="text" class="txt textC" name="attrName" id="attrName" maxlength="30"/>
							<div class="mod-help">
								<i class="ico"></i>
								<div class="text">
									<div class="text-meg">
									 <p>添加并保存成功后，页面将跳转到关联属性值页面，进行属性值关联操作。</p>
									</div>
								</div>
							</div>
				...
				<div class="formBtn">
					<button type="button" id="submitBtn" class="btnC">保&nbsp;存</button><input type="button" class="btn" value="取&nbsp;消" onclick="window.location.href='${ctx}/attr/list'" />
				</div>
			</form>
		</div>
		<!-- addTemplate end -->
