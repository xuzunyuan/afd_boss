		...
		<script type="text/javascript">
			$(function(){
				$(document).on("click", "#save", function(){
					...
					$.post(
						"${ctx}/spec/updateSpec",
						{specId:"${spec.specId}", specName: specName, pinyin: py},
						function(result){
							if(result == 0){
			...
			<form class="form formA" action="${ctx}/spec/saveSpec" method="post">
				<fieldset>
					...
					<dl class="item">
						...
						<dd class="item-cont">
							<input id="specName" name="specName" type="text" class="txt textC" value="<c:out value="${spec.specName }"/>" maxlength="30"/>
							<div class="mod-help">
								<i class="ico"></i>
								<div class="text">
									<div class="text-meg">
									 <p>规格名保存成功后，页面将跳转回列表页。</p>
									</div>
								</div>
							</div>
					...
					<dl class="item">
						...
						<dd class="item-cont">
							<input id="pinyin" name="pinyin" type="text" class="txt textC" value="<c:out value='${spec.pingyin}'/>" />
							<div class="mod-help">
								<i class="ico"></i>
								<div class="text">
									<div class="text-meg">
