		...
		<script type="text/javascript">
			$(function(){
				$(document).on("click", "#save", function(){
					...
					$.post(
						"${ctx}/specvalue/saveSpecValue",
						{specValueName: specValueName, pinyin: py, imgUrl: imgUrl},
						function(data){
			...
			function reload(){
				location.href = "${ctx}/specvalue/addSpecValue";
			}
		</script>
			...
			<form class="form formA">
				<fieldset>
					...
					<dl class="item">
						...
						<dd class="item-cont">
							<input id="specValueName" name="specValueName" type="text" class="txt textC" maxlength="30"/>
							<div class="mod-help">
								<i class="ico"></i>
								<div class="text">
									<div class="text-meg">
									 <p>添加并保存成功后，可继续添加新的规格值。</p>
									</div>
								</div>
							</div>
					...
					<dl class="item">
						...
						<dd class="item-cont">
							<img id="img" src="../static/img/temp/color2.png" rid="" width="13" height="13" class="colorBlock" style="vertical-align:middle;float:left;">
